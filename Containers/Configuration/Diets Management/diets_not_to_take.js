...
function DietsNotToTakeManagement() {
  ...
  }, [state.createDietsNotToTakeSuccess, state.updateDietsNotToTakeSuccess])


  useEffect(() => {
    if (CommonState.getDietsNotToTakeSuccess) {
      setIsLoading(false)
      setAllDietsList(CommonState.getDietsNotToTakeSuccess.allDiets)
      addToast("Success!", {
        appearance: "success",
  ...
  useEffect(() => {
    ...
    if (state.createDietsNotToTakeSuccess) {
    ...
    if (state.createDietsNotToTakeFailure) {
      setIsSubmiting(false)
      addToast("Error!", {
        appearance: "error",
  ...
  }, [state.createDietsNotToTakeSuccess, state.createDietsNotToTakeFailure])
  ...
  let handleSubmit = (e) => {
    ...
    if (currentMode === 'Edit') {
      dispatch(ACTIONS.updateDietsNotToTake(dietsPayload))
    }
    else {
      if (currentMode !== 'view') {
        dispatch(ACTIONS.createDietsNotToTake(dietsPayload));
      }
    }
  }
  ...
  useEffect(() => {
    if (state.updateDietsNotToTakeSuccess) {
      setDietsPayload({
        UID: "",
        description: "",
        hi_description: "",
    ...
    if (state.updateDietsNotToTakeFailure) {
      setIsSubmiting(false)
      addToast("Error!", {
        appearance: "error",
  ...
  }, [state.updateDietsNotToTakeSuccess, state.updateDietsNotToTakeFailure])
                                                  ...
                                                  <ul className="dropdown-menu " aria-labelledby="navbarDropdown">
                                                    <li>
                                                      <div onClick={() => changeMode(index, 'view')}>
                                                        <span className="dropdown-item"><CommonText en="View" hi="देखे" /></span>
                                                      </div>
                                                    </li>
                                                    <li>
...
export default DietsNotToTakeManagement