...
function MedicineInstruction() {
  ...
  }, [state.createMedicineInstructionSuccess, state.updateMedicineInstructionSuccess])


  useEffect(() => {
    if (CommonState.getMedicineInstructionSuccess) {
      setIsLoading(false)
      setAllInstructionList(CommonState.getMedicineInstructionSuccess.allInstructions)
      addToast("Success!", {
        appearance: "success",
  ...
  useEffect(() => {
    ...
    if (state.createMedicineInstructionSuccess) {
    ...
    if (state.createMedicineInstructionFailure) {
      setIsSubmiting(false)
      addToast("Error!", {
        appearance: "error",
  ...
  }, [state.createMedicineInstructionSuccess, state.createMedicineInstructionFailure])
  ...
  let handleSubmit = (e) => {
    ...
    if (currentMode === 'Edit') {
      dispatch(ACTIONS.updateMedicineInstruction(instructionPayload))
    }
    else {
      if (currentMode !== 'view') {
        dispatch(ACTIONS.createMedicineInstruction(instructionPayload));
      }
    }
  }
  ...
  useEffect(() => {
    if (state.updateMedicineInstructionSuccess) {
      setInstructionPayload({
        UID: "",
        instruction: "",
        hi_instruction: "",
    ...
    if (state.updateMedicineInstructionFailure) {
      setIsSubmiting(false)
      addToast("Error!", {
        appearance: "error",
  ...
  }, [state.updateMedicineInstructionSuccess, state.updateMedicineInstructionFailure])
