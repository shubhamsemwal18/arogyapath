...
function SpecialInstruction() {
  ...
  }, [state.createSpecialInstructionSuccess,state.updateSpecialInstructionSuccess])

  
  useEffect(() => {
    if (CommonState.getSpecialInstructionSuccess) {
      setIsLoading(false)
      setAllInstructionList(CommonState.getSpecialInstructionSuccess.allInstructions)
      addToast("Success!", {
                appearance: "success",
  ...
  useEffect(() => {
    ...
    if (state.createSpecialInstructionSuccess) {
    ...
    if (state.createSpecialInstructionFailure) {
      setIsSubmiting(false)
      addToast("Error!", {
        appearance: "error",
  ...
  }, [state.createSpecialInstructionSuccess, state.createSpecialInstructionFailure])
  ...
  let handleSubmit = (e) => {
    ...
    if(currentMode === 'Edit'){
      dispatch(ACTIONS.updateSpecialInstruction(instructionPayload))
    }
    else{
      if(currentMode !== 'view'){
        dispatch(ACTIONS.createSpecialInstruction(instructionPayload));
      }
    }
  }
  ...
  useEffect(() => {
    if (state.updateSpecialInstructionSuccess) {
      setInstructionPayload({
        UID:"",
        instruction : "",
        hi_instruction: "",
    ...
    if (state.updateSpecialInstructionFailure) {
      setIsSubmiting(false)
        addToast("Error!", {
            appearance: "error",
...
}, [state.updateSpecialInstructionSuccess, state.updateSpecialInstructionFailure])
