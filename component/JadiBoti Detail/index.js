                ...
                <div className="container">
                    <div className="row ">
                        <div className="col-md-12 text-center">
                            <p className="common-redirect-banner-title"><CommonText en="JadiBoti Detail" hi="जड्डीबूटी विवरण"/> </p>
                    ...
                    <div className='row'>
                        <div className='col-md-6 col-lg-7'>
                            <div className={aboutStyle.aboutSingleLeft}>
                                ...
                                <CommonText en="JadiBoti Detail" hi="जड्डीबूटी विवरण"/>
                                    </h1>
                        ...
                        <div className='col-md-6 col-lg-5'>
                          ...
                          <Image src="/images/jadiBotiDetail.jpg" alt="aboutpic" layout='fill'/>
                          </div>
                        </div>
                    </div>
                </div>
